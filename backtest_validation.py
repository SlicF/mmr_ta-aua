...
class BacktestValidator:
    ...
    def split_season_by_cutoff(
        ...
        """
        csv_file = f"csv_modalidades/{self.modalidade}_{season}.csv"
    ...
    def generate_historical_forecast(
        ...
        if previous_season:
            prev_elo_file = f"elo_ratings/elo_{self.modalidade}_{previous_season}.csv"
    ...
    def _print_summary(self, all_metrics: List[Dict]):
        ...
        summary_file = f"elo_ratings/backtest_summary_{self.modalidade}.json"
